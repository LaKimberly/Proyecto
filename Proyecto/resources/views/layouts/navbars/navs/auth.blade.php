    ...
    <div class="collapse navbar-collapse justify-content-end">
      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item dropdown">
          <!-- <a class="nav-link" href="{{ route('cart.index') }}" id="navbarDropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> -->
          <a class="nav-link" href="{{ route('cart.index') }}" class="tooltip-test" title="Carrito de compras">
